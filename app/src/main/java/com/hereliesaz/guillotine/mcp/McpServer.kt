 ...
 * that remote control is the point of the server. Note it currently exposes unauthenticated
 * read/write editor control; if it's ever run on untrusted networks, add a token/handshake.
 */
