...
object VideoFilterCatalog {
    ...
    val specs: List<Spec> = listOf(
        ...
        ) { val k = it.d(pLens); "lenscorrection=cx=0.5:cy=0.5:k1=${-k}:k2=${-k / 4}" },
        Spec(
            "mirror",
        ...
        ) { "noise=alls=${it.i(pGrain)}:allf=t+u" },
        Spec(
            "vignette",
        ...
        ) { val s = it.i(pVhs); "rgbashift=rh=$s:bh=${-s},noise=alls=12:allf=t" },
        Spec(
        ...
        ) { val a = it.i(pCa); "rgbashift=rh=$a:bh=${-a}" },
        Spec(
            "glow",
        ...
        ) { "split[a][b];[b]gblur=sigma=10[bl];[a][bl]blend=all_mode=screen:all_opacity=${it.d(pGlow)}" },
        Spec(
            "old_film",
        ...
        ) { val n = it.i(pPixel); "pixelize=w=$n:h=$n" },
        Spec(
            "warm",
        ...
        ) { val n = it.i(pGrid); "drawgrid=width=$n:height=$n:thickness=1:color=white@0.4" },
    )
